...
## Лучший результат
- **Public LB: 0.8472** (EXP-011: Optuna per-target + стекинг)
...
## Что сработало
- **Стекинг OOF**: +0.012 macro AUC (0.7977→0.8096 на 100k). Слабые таргеты взлетели: target_5_2 +0.081, target_2_5 +0.071
